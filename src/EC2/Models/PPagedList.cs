...
namespace EC2.Models
{
    ...
    public class PPagedList<T>: IPagedList
    {
        public PPagedList(PagedListMetaData matadata, List<T> items)
        {
            ...
            PageNumber = matadata.PageNumber;
            PageSize = matadata.PageSize;
            HasPreviousPage = matadata.HasPreviousPage;
            HasNextPage = matadata.HasNextPage;
            IsFirstPage = matadata.IsFirstPage;
            IsLastPage = matadata.IsLastPage;
            FirstItemOnPage = matadata.FirstItemOnPage;
            LastItemOnPage = matadata.LastItemOnPage;
            /// Set Items
            this.Items = items;
        }
